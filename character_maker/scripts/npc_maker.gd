...
const BODY_PARTS = {
	"male":
	{
		"belt": ["male_belt_1", "male_belt_2", "male_belt_3", "male_belt_4"],
	...
	"female":
	{
		"belt": ["female_belt_1", "female_belt_2", "female_belt_3", "female_belt_3"],
...
const PERSONA = {
	"SKIN_COLOR":
	["dfd2c8", "ffe4d1", "ffc399", "ebc2a6", "e2c1aa", "ffcba7", "ffba8a", "e19d66", "bf7942", "935d34", "6d4425"],
...
func get_animation(npc_type: String, animation_group: String):
	var animation_selected = BODY_PARTS[npc_type].animation[animation_group][
		randi() % BODY_PARTS[npc_type].animation[animation_group].size()
	]
